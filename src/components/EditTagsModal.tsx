...
export const EditTagsModal = ({availableTags, deleteTag, updateTag} : ModalProps) => {
  ...
  return (
    <>
      <button
        className="bg-pink-500 text-white active:bg-pink-600 font-bold px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 text-xl"
        type="button"
            ...
            <div className="relative w-1/3 my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                  <button
                    className="bg-emerald-500 text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 font-bold"
                    type="button"
                    onClick={() => {setShowModal(false)}}
                  >
                    Save Changes
